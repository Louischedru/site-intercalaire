...
filmarticleRouter.get('/oneprivate/:id', auth, controller.getOnePrivate);
...
filmarticleRouter.put('/other/:id', auth, controller.modifyOther);
filmarticleRouter.put('/setpublished/:id', auth, controller.setIsPublished);
